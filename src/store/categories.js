export const themas = [
  { hoofd: "Tactiek", sub: ["TT+ (TT- => TT+)", "TT- (TT+ => TT-)"] },
...
export const subthemas = [
  {
    hoofd: "Tactiek",
    subs: [
      { name: "In possession (B+)", $isDisabled: true },
      { name: "Build-up", plus: true },
      { name: "Midfield progression", plus: true },
      { name: "Final third", plus: true },
      { name: "Out of possession (B-)", $isDisabled: true },
      { name: "Pressing", plus: false },
      { name: "Defensive shape", plus: false },
      { name: "Protecting goal", plus: false },
      { name: "Transition to attack (B- naar B+)", $isDisabled: true },
      { name: "Counter-attacking", plus: true },
      { name: "Transition to B+", plus: true },
      { name: "Transition to defense (B+ naar B-)", $isDisabled: true },
      { name: "Fall-back", plus: false },
      { name: "Counter-pressing", plus: false },
      { name: "Transition to B-", plus: false },
    ],
  },
  {
    hoofd: "Techniek",
    subs: [
      { name: "1v1", $isDisabled: true },
      { name: "Tegenstander frontaal" },
      { name: "Tegenstander schuin-frontaal" },
      { name: "Tegenstander zijwaarts" },
      { name: "Tegenstander in de rug" },
      { name: "Ball mastery", $isDisabled: true },
      { name: "Dribbling" },
      { name: "Passing" },
      { name: "Shooting" },
      { name: "Receiving" },
      ...
      { name: "Defending" },
      { name: "Set pieces" },
      { name: "Anders", $isDisabled: true },
      { name: "Body shape" },
      { name: "Scanning" },
      { name: "Timing" },
      { name: "Handelingssnelheid" },
    ],
  },
  {
    hoofd: "Fysiek",
    subs: [
      { name: "Key aspects", $isDisabled: true },
      { name: "Agility" },
      { name: "Speed" },
      { name: "Strength" },
      { name: "Power" },
      ...
      { name: "Aerobic (EDT/IDT)" },
      { name: "Anaerobic (EIT/IIT)" },
    ],
  },
  {
    hoofd: "Stilstaande fases",
    subs: [
      { name: "Voor", $isDisabled: true },
      { name: "Corners (voor)" },
      { name: "Inworpen (voor)" },
      { name: "Vrije trappen (voor)" },
      { name: "Tegen", $isDisabled: true },
      { name: "Corners (tegen)" },
      { name: "Inworpen (tegen)" },
      { name: "Vrije trappen (tegen)" },
    ],
  },
];
